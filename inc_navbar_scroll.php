    ...
    <div class="navigation">
        <div class="container">
            <div class="row  justify-content-between">
                ...
                <!-- non-login-->
                    <ul class="nav-list">
                        <li class="nav-link scroll"><a href="index.php">Home</a></li>
                        <li class="nav-link scroll"><a href="tourist_attraction.php">Tourist Attraction</a></li>
                        <li class="nav-link scroll"><a href="register.php">Register</a></li>
                        <li class="nav-link scroll"><a href="signin.php"><i class="fas fa-sign-in-alt text-orange pe-2"></i>Sign in</a></li>
