<nav>
    ...
    <div class="container">
          ...
          <div class="col-xl-4 col-2">
            ...
            <!-- non-login-->
                <ul class="nav-list">
                    <li class="nav-link"><a href="index.php">Home</a>
                     </li>
                    <li class="nav-link "><a href="tourist_attraction.php">Tourist Attraction</a></li>
                    <li class="nav-link "><a href="register.php">Register</a>
                     </li>
                     <li class="nav-link "><a href="signin.php"><i class="fas fa-sign-in-alt text-orange pe-2"></i>Sign in</a>
                     </li>
                    <li class="nav-link">
                    <div class="dropdown">
                      <button class="btn btn-lang dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="images/lang-en.png" class="lang">EN
                      </button>
                      <ul class="dropdown-menu lang" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#"><img src="images/090-thailand-1.png" class="lang">ไทย</a></li>
                      </ul>
                    </div>    
                </li>
                  </ul>
