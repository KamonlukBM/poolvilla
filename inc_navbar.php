<nav>
    ...
    <div class="container">
          ...
          <div class="col-xl-4 col-2">
            ...
            <!-- when-login-->
                <ul class="nav-list">
                 <li class="nav-link non-scroll"><a href="index.php">Home</a>
                    </li>
                     <li class="nav-link non-scroll"><a href="tourist_attraction.php">Tourist Attraction</a></li>
                 <li class="nav-link non-scroll">
                    <div class="dropdown profile">
                        <button class="dropbtn profile"><i class="fas fa-user-circle name-text me-2 text-orange"></i>Welcome,Elle</button>
